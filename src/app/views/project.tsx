...
export default function ProjectDetail({ data }: { data: ProjectDetail }) {
  const { name, description, url, cover, product_a, product_b, product_c } =
    data.attributes;
  ...
  return (
    <div className="md:col-span-2 md:grid grid-cols-2">
      <div className="space-y-6">
        <h1 className="font-body text-4xl font-medium dark:text-white">
          {name}
        </h1>
      ...
      <div className="w-2/4 mx-auto">
        ...
        <div className="font-body w-full flex justify-center mt-[20px] dark:text-white">
          <Link
            href={url}
            target="_blank"
            className="border rounded-lg hover:border-neutral-500 transition-all px-5 py-2"
          >
            View Project
          </Link>
        </div>
