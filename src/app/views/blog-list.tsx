...
//         </div>
//       </div> */}
//       <p className="text-stone-500">Content coming soon, check back in a week</p>
//       {children && children}
//     </div>
//   );
// }
...
export default function PostList() {
  return(
    <>
      <p className="text-stone-300 font-body col-span-2">Nothing here yet... check back in a while</p>
    </>
  )
}
