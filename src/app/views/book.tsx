  ...
  return (
    <article className="col-span-2 grid grid-cols-2 mt-[60px]">
      <div className="space-y-6 col-span-2 md:col-span-1">
        <h1 className="font-display font-light text-4xl dark:text-neutral-100">
          {title}
        </h1>
      ...
      <div className="md:col-start-2 mx-auto col-span-2 w-full md:w-auto md:w-auto md:p-12 md:mt-0 mt-[40px]">
        ...
        <div className="font-body font-light w-full flex justify-center mt-[20px] dark:text-neutral-100">
          <Link
            href={book_url}
            target="_blank"
